...
% adjacent bins whereby a flat top window is applied.
...
f0 = 1000;           % frequency of the sine in Hz; f0 is an integer 
                     % fraction of fs
...
ylabel('$20\log_{10} \left|\overline{X}_{w,\mathrm{SS}}(k)\right|$', 'interpreter', 'latex');
